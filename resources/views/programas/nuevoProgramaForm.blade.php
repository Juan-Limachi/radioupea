<x-app-layout>
    <div class="py-2">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="pb-2">
                <a href="/programas" class="btn btn-primary btn-round">VER PROGRAMAS</a>
            </div>
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg ">
                <div class="card-body">

                    <form action="{{ route('guardarNuevoPrograma') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        {{-- {{ csrf_field() }} --}}
                        <div class="row">
                            <div class="col-lg-8">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <div class="text-center mt-2" id="filePreviewContainer">
                                        <img id="filePreview" width="350" class="rounded mx-auto d-block" src="{{ asset('medias/noImage.png') }}" alt="">
                                    </div>
                                    <div class="input-group d-flex justify-content-center mt-3">
                                        <input id="portada" name="portada" type="file" accept="image/*, video/*" class="form-control" style="display: none;" onchange="handleFileChange(event)">
